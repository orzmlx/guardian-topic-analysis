...
% Use acl.sty for compilation,
% Recommended to use the official *ACL template on Overleaf and copy the content of this framework.
\usepackage[hyperref]{acl}
\usepackage{mathptmx}
\renewcommand{\ttdefault}{lmtt} % Use Latin Modern Typewriter to avoid Courier font issues
% \usepackage{microtype} % Optional; try installing local microtype to improve micro-typography
...
% Title
\title{Event-Driven Topic Shifts in The Guardian:\newline A Comparative Analysis of BERTopic and LDA around Queen Elizabeth II's Passing}

% Example for multiple authors: use \\ to separate lines
\author{
  Liuxi Mei \\
...
\begin{figure}[h!]
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{tabular}{@{}cc@{}}
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_pre_topic_0.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_post_topic_0.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_pre_topic_1.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_post_topic_1.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_pre_topic_2.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_post_topic_2.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_pre_topic_3.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_post_topic_3.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_pre_topic_4.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/BERTopic_post_topic_4.png} \\
    \end{tabular}
  \end{minipage}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{tabular}{@{}cc@{}}
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_pre_topic_0.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_post_topic_0.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_pre_topic_1.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_post_topic_1.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_pre_topic_2.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_post_topic_2.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_pre_topic_3.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_post_topic_3.png} \\
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_pre_topic_4.png} &
      \includegraphics[width=0.4\linewidth,trim=0 0 0 0,clip]{../images/wordclouds/LDA_post_topic_4.png} \\
    \end{tabular}
  \end{minipage}
...
The pre-event period comprises articles published prior to the exclusion buffer, while the post-event period comprises those published after. The 'filtered' designation indicates that direct event-related articles have been excluded. \#Documents denotes the number of articles in each split, and Avg. Tokens represents the average number of tokens per article after preprocessing.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{../images/topic_time_series.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{../images/lda_combined_time_series.png}
...
% ============ 5 Experiments ============
\section{Experiments}
We train LDA and BERTopic models on the filtered pre- and post-event corpora (Section~3). For BERTopic, we use \texttt{all-MiniLM-L6-v2} embeddings, UMAP, and HDBSCAN; for LDA, we use CountVectorizer and scikit-learn's implementation. Models were trained independently on the event-excluded subsets. Evaluation combines quantitative metrics (standard $C_v$ for BERTopic, $C_{UMass}$ for LDA) and qualitative inspection of top words and time series. Statistical tests include Pearson chi-square for distribution shifts and Z-tests for proportion differences.
...
\textbf{BERTopic} (Figure~\ref{fig:topic-timeseries}) captures thematic continuity with distinct "dips" and "recoveries", validating the "agenda reset" hypothesis. Topics like "Political Leadership" show increased prominence post-event.
...
A Pearson chi-square test confirms a highly significant distribution change (\(\chi^2 = 491.618,\; p < 10^{-6}\)), indicating a major shift in the media agenda.
...
% ============ 8 Limitations (Brief as required by ACL) ============
\section{Limitations}
...
\section{Ethical Considerations and AI Usage}
This study involves the analysis of public news data; no private or personally identifiable information was processed. We acknowledge the use of Large Language Models (specifically GPT-4o) to assist with \LaTeX{} formatting, code refactoring, and linguistic polishing to enhance readability. All scientific claims, experimental designs, and data interpretations remain the sole responsibility of the author.

% ============ 10 Data and Code Availability ============
\section{Data and Code Availability}
The complete code for data collection, preprocessing, and topic modelling, along with the processed datasets used in this study, are publicly available at: \url{https://github.com/orzmlx/guardian-topic-analysis}.
...
% Please create references.bib in the same directory and put all citations in it;
% Use citation commands like \citep and \citet to comply with *ACL style.
